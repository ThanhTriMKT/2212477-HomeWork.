...
{
    public partial class Class2 : Class2
    {
        public Class2()
        {
            InitializeComponent();
        ...
        private void phanthanhtriToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            if (textBox1.Text.ToString() == "Tri" && textBox2.Text.ToString() == "123")
            {
